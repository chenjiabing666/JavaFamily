package com.java.family.shardingjdbc005.dao;
...
public interface ProductMapper {
    @Insert(value = "INSERT INTO `product_base`(product_id,shop_id,name,price,origin_address,type_id) VALUE(#{productId},#{shopId}, #{name}, #{price}, #{originAddress},#{typeId});")
    ...
    @Options(useGeneratedKeys=true, keyProperty="productId", keyColumn="product_id")
    int insertProductBaseNoProductId(Product product);
    ...
    @Select("select count(*) from product_type")
    int countByShopId();
}
